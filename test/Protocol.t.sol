...
contract ProtocolTests is Test {
    ...
    function test_updateCollateralInterval_invalid() external {
        _spogRegistrar.updateConfig(SPOGRegistrarReader.UPDATE_COLLATERAL_INTERVAL, uint256(0));

        vm.expectRevert(IProtocol.InvalidUpdateCollateralInterval.selector);
        _protocol.updateCollateralInterval();
    }
